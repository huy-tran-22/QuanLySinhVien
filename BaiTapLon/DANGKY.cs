...
namespace BaiTapLon
{
    public partial class DANGKY : Form
    {
        ...
        private void btdangky_Click(object sender, EventArgs e)
        {
            ...
            string querysql1 = "select * from USERS where Magv = '" + taikhoan + "'";
            string querysql2 = "select Magv from GIAOVIEN where Magv = '" + taikhoan + "' ";
            ...
            else
            {
                ...
                if (KetNoi.dtreader.Read() == true)
                {
                    if (matkhau == repass)
                    {
                        string sql = "Insert into USERS VALUES('" + taikhoan + "', '" + matkhau + "', '" + loaitk + "')";
                        string[] name = { "@Magv", "@MatKhau", "@LoaiTaikhoan" };
                        object[] value = { taikhoan, matkhau, loaitk };
                ...
                {
                    MessageBox.Show("Không tồn tại mã giáo viên này trong CSDL", "Thông Báo");
                }
            }
            KetNoi.dongketnoi();
        }
